...
-module(diameter_3gpp_ts32_299_rf).
...
-export_records([diameter_rf_ACR,
                 diameter_rf_ACA,
                 'diameter_rf_Proxy-Info',
                 'diameter_rf_Failed-AVP',
                 'diameter_rf_Experimental-Result',
                 'diameter_rf_Vendor-Specific-Application-Id',
                 diameter_rf_Tunneling,
                 'diameter_rf_Cost-Information',
                 'diameter_rf_Unit-Value',
                 'diameter_rf_Multiple-Services-Credit-Control',
                 'diameter_rf_Granted-Service-Unit',
                 'diameter_rf_Requested-Service-Unit',
                 'diameter_rf_Used-Service-Unit',
                 'diameter_rf_CC-Money',
                 'diameter_rf_G-S-U-Pool-Reference',
                 'diameter_rf_Final-Unit-Indication',
                 'diameter_rf_Redirect-Server',
                 'diameter_rf_Service-Parameter-Info',
                 'diameter_rf_Subscription-Id',
                 'diameter_rf_User-Equipment-Info',
                 'diameter_rf_Access-Network-Charging-Identifier-Gx',
                 'diameter_rf_Allocation-Retention-Priority',
                 'diameter_rf_Application-Detection-Information',
                 'diameter_rf_Charging-Rule-Definition',
                 'diameter_rf_Charging-Rule-Install',
                 'diameter_rf_Charging-Rule-Remove',
                 'diameter_rf_Charging-Rule-Report',
                 'diameter_rf_CoA-Information',
                 'diameter_rf_Conditional-APN-Aggregate-Max-Bitrate',
                 'diameter_rf_Default-EPS-Bearer-QoS',
                 'diameter_rf_Default-QoS-Information',
                 'diameter_rf_Event-Report-Indication',
                 'diameter_rf_Fixed-User-Location-Info',
                 'diameter_rf_Flow-Information',
                 'diameter_rf_Packet-Filter-Information',
                 'diameter_rf_Presence-Reporting-Area-Information',
                 'diameter_rf_QoS-Information',
                 'diameter_rf_Redirect-Information',
                 'diameter_rf_Routing-Filter',
                 'diameter_rf_Routing-Rule-Definition',
                 'diameter_rf_Routing-Rule-Install',
                 'diameter_rf_Routing-Rule-Remove',
                 'diameter_rf_TDF-Information',
                 'diameter_rf_Tunnel-Information',
                 'diameter_rf_TFT-Packet-Filter-Information',
                 'diameter_rf_Usage-Monitoring-Information',
                 diameter_rf_Flows,
                 'diameter_rf_Access-Network-Info-Change',
                 'diameter_rf_Access-Transfer-Information',
                 'diameter_rf_Accumulated-Cost',
                 'diameter_rf_Additional-Content-Information',
                 'diameter_rf_Address-Domain',
                 'diameter_rf_AF-Correlation-Information',
                 'diameter_rf_Announcement-Information',
                 'diameter_rf_AoC-Cost-Information',
                 'diameter_rf_AoC-Information',
                 'diameter_rf_AoC-Service',
                 'diameter_rf_AoC-Subscription-Information',
                 'diameter_rf_APN-Rate-Control',
                 'diameter_rf_APN-Rate-Control-Downlink',
                 'diameter_rf_APN-Rate-Control-Uplink',
                 'diameter_rf_Application-Server-Information',
                 'diameter_rf_Basic-Service-Code',
                 'diameter_rf_Called-Identity-Change',
                 'diameter_rf_Coverage-Info',
                 'diameter_rf_CPDT-Information',
                 'diameter_rf_Current-Tariff',
                 'diameter_rf_Destination-Interface',
                 'diameter_rf_Early-Media-Description',
                 'diameter_rf_Enhanced-Diagnostics',
                 diameter_rf_Envelope,
                 'diameter_rf_Event-Type',
                 'diameter_rf_Incremental-Cost',
                 'diameter_rf_IMS-Information',
                 'diameter_rf_Inter-Operator-Identifier',
                 'diameter_rf_ISUP-Cause',
                 'diameter_rf_LCS-Client-ID',
                 'diameter_rf_LCS-Client-Name',
                 'diameter_rf_LCS-Information',
                 'diameter_rf_LCS-Requestor-ID',
                 'diameter_rf_Location-Info',
                 'diameter_rf_Location-Type',
                 'diameter_rf_MBMS-Information',
                 'diameter_rf_Message-Body',
                 'diameter_rf_Message-Class',
                 'diameter_rf_MM-Content-Type',
                 'diameter_rf_MMS-Information',
                 'diameter_rf_MMTel-Information',
                 'diameter_rf_Monitoring-Event-Information',
                 'diameter_rf_Monitoring-Event-Report-Data',
                 'diameter_rf_Next-Tariff',
                 'diameter_rf_NIDD-Submission',
                 'diameter_rf_NNI-Information',
                 'diameter_rf_Offline-Charging',
                 'diameter_rf_Originator-Address',
                 'diameter_rf_Originator-Interface',
                 'diameter_rf_Originator-Received-Address',
                 'diameter_rf_Participant-Group',
                 'diameter_rf_PoC-Information',
                 'diameter_rf_PoC-User-Role',
                 'diameter_rf_ProSe-Direct-Communication-Reception-Data-Container',
                 'diameter_rf_ProSe-Direct-Communication-Transmission-Data-Container',
                 'diameter_rf_ProSe-Information',
                 'diameter_rf_PS-Furnish-Charging-Information',
                 'diameter_rf_PS-Information',
                 'diameter_rf_Radio-Parameter-Set-Info',
                 'diameter_rf_RAN-Secondary-RAT-Usage-Report',
                 'diameter_rf_Rate-Element',
                 'diameter_rf_Real-Time-Tariff-Information',
                 'diameter_rf_Recipient-Address',
                 'diameter_rf_Recipient-Info',
                 'diameter_rf_Recipient-Received-Address',
                 'diameter_rf_Related-Change-Condition-Information',
                 'diameter_rf_Related-Trigger',
                 'diameter_rf_Remaining-Balance',
                 'diameter_rf_Scale-Factor',
                 'diameter_rf_SCS-AS-Address',
                 'diameter_rf_SDP-Media-Component',
                 'diameter_rf_SDP-TimeStamps',
                 'diameter_rf_Service-Data-Container',
                 'diameter_rf_Service-Specific-Info',
                 'diameter_rf_SM-Device-Trigger-Information',
                 'diameter_rf_SMS-Information',
                 'diameter_rf_Supplementary-Service',
                 'diameter_rf_Talk-Burst-Exchange',
                 'diameter_rf_Tariff-Information',
                 'diameter_rf_Time-Quota-Mechanism',
                 'diameter_rf_Time-Stamps',
                 'diameter_rf_Traffic-Data-Volumes',
                 'diameter_rf_Transmitter-Info',
                 diameter_rf_Trigger,
                 'diameter_rf_Trunk-Group-Id',
                 'diameter_rf_TWAN-User-Location-Info',
                 'diameter_rf_Unit-Cost',
                 'diameter_rf_User-CSG-Information',
                 'diameter_rf_UWAN-User-Location-Info',
                 'diameter_rf_Variable-Part',
                 'diameter_rf_VCS-Information',
                 'diameter_rf_TP-Previous-PS-Information',
...
rec2msg(diameter_rf_ACR) -> 'ACR';
rec2msg(diameter_rf_ACA) -> 'ACA';
rec2msg(_) -> erlang:error(badarg).

msg2rec('ACR') -> diameter_rf_ACR;
msg2rec('ACA') -> diameter_rf_ACA;
msg2rec(_) -> erlang:error(badarg).

name2rec('Proxy-Info') -> 'diameter_rf_Proxy-Info';
name2rec('Failed-AVP') -> 'diameter_rf_Failed-AVP';
name2rec('Experimental-Result') ->
    'diameter_rf_Experimental-Result';
name2rec('Vendor-Specific-Application-Id') ->
    'diameter_rf_Vendor-Specific-Application-Id';
name2rec('Tunneling') -> diameter_rf_Tunneling;
name2rec('Cost-Information') ->
    'diameter_rf_Cost-Information';
name2rec('Unit-Value') -> 'diameter_rf_Unit-Value';
...
name2rec('Used-Service-Unit') ->
    'diameter_rf_Used-Service-Unit';
name2rec('CC-Money') -> 'diameter_rf_CC-Money';
...
name2rec('Usage-Monitoring-Information') ->
    'diameter_rf_Usage-Monitoring-Information';
name2rec('Flows') -> diameter_rf_Flows;
...
name2rec('AoC-Information') ->
    'diameter_rf_AoC-Information';
name2rec('AoC-Service') -> 'diameter_rf_AoC-Service';
...
name2rec('Enhanced-Diagnostics') ->
    'diameter_rf_Enhanced-Diagnostics';
name2rec('Envelope') -> diameter_rf_Envelope;
name2rec('Event-Type') -> 'diameter_rf_Event-Type';
...
name2rec('Inter-Operator-Identifier') ->
    'diameter_rf_Inter-Operator-Identifier';
name2rec('ISUP-Cause') -> 'diameter_rf_ISUP-Cause';
...
name2rec('MBMS-Information') ->
    'diameter_rf_MBMS-Information';
name2rec('Message-Body') -> 'diameter_rf_Message-Body';
...
name2rec('Monitoring-Event-Report-Data') ->
    'diameter_rf_Monitoring-Event-Report-Data';
name2rec('Next-Tariff') -> 'diameter_rf_Next-Tariff';
...
name2rec('RAN-Secondary-RAT-Usage-Report') ->
    'diameter_rf_RAN-Secondary-RAT-Usage-Report';
name2rec('Rate-Element') -> 'diameter_rf_Rate-Element';
...
name2rec('Remaining-Balance') ->
    'diameter_rf_Remaining-Balance';
name2rec('Scale-Factor') -> 'diameter_rf_Scale-Factor';
...
name2rec('Time-Quota-Mechanism') ->
    'diameter_rf_Time-Quota-Mechanism';
name2rec('Time-Stamps') -> 'diameter_rf_Time-Stamps';
name2rec('Traffic-Data-Volumes') ->
    'diameter_rf_Traffic-Data-Volumes';
name2rec('Transmitter-Info') ->
    'diameter_rf_Transmitter-Info';
name2rec('Trigger') -> diameter_rf_Trigger;
name2rec('Trunk-Group-Id') ->
    'diameter_rf_Trunk-Group-Id';
name2rec('TWAN-User-Location-Info') ->
    'diameter_rf_TWAN-User-Location-Info';
name2rec('Unit-Cost') -> 'diameter_rf_Unit-Cost';
