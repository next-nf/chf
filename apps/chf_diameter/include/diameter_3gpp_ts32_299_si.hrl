...
-hrl_name('diameter_3gpp_ts32_299_si.hrl').
...
-record('diameter_3gpp_charging_TP-Previous-PS-Information',
        {'QoS-Information' = [],
         'SGSN-Address' = [],
         '3GPP-SGSN-MCC-MNC' = [],
         '3GPP-MS-TimeZone' = [],
...
-ifndef('DIAMETER_3GPP_CHARGING_SERVICE-TYPE_UNKNOWN').
-define('DIAMETER_3GPP_CHARGING_SERVICE-TYPE_UNKNOWN', 0).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_SERVICE-TYPE_LOGIN').
-define('DIAMETER_3GPP_CHARGING_SERVICE-TYPE_LOGIN', 1).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_SERVICE-TYPE_FRAMED').
-define('DIAMETER_3GPP_CHARGING_SERVICE-TYPE_FRAMED', 2).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_SERVICE-TYPE_CALLBACK_LOGIN').
-define('DIAMETER_3GPP_CHARGING_SERVICE-TYPE_CALLBACK_LOGIN', 3).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_SERVICE-TYPE_CALLBACK_FRAMED').
-define('DIAMETER_3GPP_CHARGING_SERVICE-TYPE_CALLBACK_FRAMED', 4).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_SERVICE-TYPE_OUTBOUND').
-define('DIAMETER_3GPP_CHARGING_SERVICE-TYPE_OUTBOUND', 5).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_SERVICE-TYPE_ADMINISTRATIVE').
-define('DIAMETER_3GPP_CHARGING_SERVICE-TYPE_ADMINISTRATIVE', 6).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_SERVICE-TYPE_NAS_PROMPT').
-define('DIAMETER_3GPP_CHARGING_SERVICE-TYPE_NAS_PROMPT', 7).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_SERVICE-TYPE_AUTHENTICATE_ONLY').
-define('DIAMETER_3GPP_CHARGING_SERVICE-TYPE_AUTHENTICATE_ONLY', 8).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_SERVICE-TYPE_CALLBACK_NAS_PROMPT').
-define('DIAMETER_3GPP_CHARGING_SERVICE-TYPE_CALLBACK_NAS_PROMPT', 9).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_SERVICE-TYPE_CALL_CHECK').
-define('DIAMETER_3GPP_CHARGING_SERVICE-TYPE_CALL_CHECK', 10).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_SERVICE-TYPE_CALLBACK_ADMINISTRATIVE').
-define('DIAMETER_3GPP_CHARGING_SERVICE-TYPE_CALLBACK_ADMINISTRATIVE', 11).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_SERVICE-TYPE_VOICE').
-define('DIAMETER_3GPP_CHARGING_SERVICE-TYPE_VOICE', 12).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_SERVICE-TYPE_FAX').
-define('DIAMETER_3GPP_CHARGING_SERVICE-TYPE_FAX', 13).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_SERVICE-TYPE_MODEM_RELAY').
-define('DIAMETER_3GPP_CHARGING_SERVICE-TYPE_MODEM_RELAY', 14).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_SERVICE-TYPE_IAPP_REGISTER').
-define('DIAMETER_3GPP_CHARGING_SERVICE-TYPE_IAPP_REGISTER', 15).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_SERVICE-TYPE_IAPP_AP_CHECK').
-define('DIAMETER_3GPP_CHARGING_SERVICE-TYPE_IAPP_AP_CHECK', 16).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_SERVICE-TYPE_AUTHORIZE_ONLY').
-define('DIAMETER_3GPP_CHARGING_SERVICE-TYPE_AUTHORIZE_ONLY', 17).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_SERVICE-TYPE_FRAMED_MANAGEMENT').
-define('DIAMETER_3GPP_CHARGING_SERVICE-TYPE_FRAMED_MANAGEMENT', 18).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_FRAMED-PROTOCOL_PPP').
-define('DIAMETER_3GPP_CHARGING_FRAMED-PROTOCOL_PPP', 1).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_FRAMED-PROTOCOL_SLIP').
-define('DIAMETER_3GPP_CHARGING_FRAMED-PROTOCOL_SLIP', 2).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_FRAMED-PROTOCOL_ARAP').
-define('DIAMETER_3GPP_CHARGING_FRAMED-PROTOCOL_ARAP', 3).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_FRAMED-PROTOCOL_GANDALF').
-define('DIAMETER_3GPP_CHARGING_FRAMED-PROTOCOL_GANDALF', 4).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_FRAMED-PROTOCOL_XYLOGICS').
-define('DIAMETER_3GPP_CHARGING_FRAMED-PROTOCOL_XYLOGICS', 5).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_FRAMED-PROTOCOL_X_75').
-define('DIAMETER_3GPP_CHARGING_FRAMED-PROTOCOL_X_75', 6).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_FRAMED-PROTOCOL_GPRS_PDP_CONTEXT').
-define('DIAMETER_3GPP_CHARGING_FRAMED-PROTOCOL_GPRS_PDP_CONTEXT', 7).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_FRAMED-PROTOCOL_ASCEND_ARA').
-define('DIAMETER_3GPP_CHARGING_FRAMED-PROTOCOL_ASCEND_ARA', 255).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_FRAMED-PROTOCOL_MPP').
-define('DIAMETER_3GPP_CHARGING_FRAMED-PROTOCOL_MPP', 256).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_FRAMED-PROTOCOL_EURAW').
-define('DIAMETER_3GPP_CHARGING_FRAMED-PROTOCOL_EURAW', 257).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_FRAMED-PROTOCOL_EUUI').
-define('DIAMETER_3GPP_CHARGING_FRAMED-PROTOCOL_EUUI', 258).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_FRAMED-PROTOCOL_X25').
-define('DIAMETER_3GPP_CHARGING_FRAMED-PROTOCOL_X25', 259).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_FRAMED-PROTOCOL_COMB').
-define('DIAMETER_3GPP_CHARGING_FRAMED-PROTOCOL_COMB', 260).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_FRAMED-PROTOCOL_FR').
-define('DIAMETER_3GPP_CHARGING_FRAMED-PROTOCOL_FR', 261).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_FRAMED-ROUTING_NONE').
-define('DIAMETER_3GPP_CHARGING_FRAMED-ROUTING_NONE', 0).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_FRAMED-ROUTING_SEND_ROUTING_PACKETS').
-define('DIAMETER_3GPP_CHARGING_FRAMED-ROUTING_SEND_ROUTING_PACKETS', 1).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_FRAMED-ROUTING_LISTEN_FOR_ROUTING_PACKETS').
-define('DIAMETER_3GPP_CHARGING_FRAMED-ROUTING_LISTEN_FOR_ROUTING_PACKETS', 2).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_FRAMED-ROUTING_SEND_AND_LISTEN').
-define('DIAMETER_3GPP_CHARGING_FRAMED-ROUTING_SEND_AND_LISTEN', 3).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_FRAMED-COMPRESSION_NONE').
-define('DIAMETER_3GPP_CHARGING_FRAMED-COMPRESSION_NONE', 0).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_FRAMED-COMPRESSION_IPX_HEADER_COMPRESSION').
-define('DIAMETER_3GPP_CHARGING_FRAMED-COMPRESSION_IPX_HEADER_COMPRESSION', 2).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_FRAMED-COMPRESSION_STAC_LZS_COMPRESSION').
-define('DIAMETER_3GPP_CHARGING_FRAMED-COMPRESSION_STAC_LZS_COMPRESSION', 3).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_LOGIN-SERVICE_TELNET').
-define('DIAMETER_3GPP_CHARGING_LOGIN-SERVICE_TELNET', 0).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_LOGIN-SERVICE_RLOGIN').
-define('DIAMETER_3GPP_CHARGING_LOGIN-SERVICE_RLOGIN', 1).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_LOGIN-SERVICE_TCP_CLEAR').
-define('DIAMETER_3GPP_CHARGING_LOGIN-SERVICE_TCP_CLEAR', 2).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_LOGIN-SERVICE_PORTMASTER').
-define('DIAMETER_3GPP_CHARGING_LOGIN-SERVICE_PORTMASTER', 3).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_LOGIN-SERVICE_LAT').
-define('DIAMETER_3GPP_CHARGING_LOGIN-SERVICE_LAT', 4).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_LOGIN-SERVICE_X25_PAD').
-define('DIAMETER_3GPP_CHARGING_LOGIN-SERVICE_X25_PAD', 5).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_LOGIN-SERVICE_X25_T3POS').
-define('DIAMETER_3GPP_CHARGING_LOGIN-SERVICE_X25_T3POS', 6).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_LOGIN-SERVICE_UNASSIGNED').
-define('DIAMETER_3GPP_CHARGING_LOGIN-SERVICE_UNASSIGNED', 7).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_ACCT-AUTHENTIC_NONE').
-define('DIAMETER_3GPP_CHARGING_ACCT-AUTHENTIC_NONE', 0).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_ACCT-AUTHENTIC_RADIUS').
-define('DIAMETER_3GPP_CHARGING_ACCT-AUTHENTIC_RADIUS', 1).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_ACCT-AUTHENTIC_LOCAL').
-define('DIAMETER_3GPP_CHARGING_ACCT-AUTHENTIC_LOCAL', 2).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_ACCT-AUTHENTIC_REMOTE').
-define('DIAMETER_3GPP_CHARGING_ACCT-AUTHENTIC_REMOTE', 3).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_ACCT-AUTHENTIC_DIAMETER').
-define('DIAMETER_3GPP_CHARGING_ACCT-AUTHENTIC_DIAMETER', 4).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_ASYNC').
-define('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_ASYNC', 0).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_SYNC').
-define('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_SYNC', 1).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_ISDN_SYNC').
-define('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_ISDN_SYNC', 2).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_ISDN_ASYNC_V120').
-define('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_ISDN_ASYNC_V120', 3).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_ISDN_ASYNC_V110').
-define('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_ISDN_ASYNC_V110', 4).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_VIRTUAL').
-define('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_VIRTUAL', 5).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_PIAFS').
-define('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_PIAFS', 6).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_HDLC_CLEAR_CHANNEL').
-define('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_HDLC_CLEAR_CHANNEL', 7).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_X25').
-define('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_X25', 8).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_X75').
-define('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_X75', 9).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_G_3_FAX').
-define('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_G_3_FAX', 10).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_SDSL_SYMMETRIC_DSL').
-define('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_SDSL_SYMMETRIC_DSL', 11).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_IDSL_ISDN_DIGITAL_SUBSCRIBER_LINE').
-define('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_IDSL_ISDN_DIGITAL_SUBSCRIBER_LINE', 14).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_ETHERNET').
-define('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_ETHERNET', 15).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_XDSL_DIGITAL_SUBSCRIBER_LINE_OF_UNKNOWN_TYPE').
-define('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_XDSL_DIGITAL_SUBSCRIBER_LINE_OF_UNKNOWN_TYPE', 16).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_CABLE').
-define('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_CABLE', 17).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_WIRELESS_OTHER').
-define('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_WIRELESS_OTHER', 18).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_WIRELESS_IEEE_802_11').
-define('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_WIRELESS_IEEE_802_11', 19).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_TOKEN_RING').
-define('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_TOKEN_RING', 20).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_FDDI').
-define('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_FDDI', 21).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_WIRELESS_CDMA2000').
-define('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_WIRELESS_CDMA2000', 22).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_WIRELESS_UMTS').
-define('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_WIRELESS_UMTS', 23).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_WIRELESS_1X_EV').
-define('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_WIRELESS_1X_EV', 24).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_IAPP').
-define('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_IAPP', 25).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_FTTP_FIBER_TO_THE_PREMISES').
-define('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_FTTP_FIBER_TO_THE_PREMISES', 26).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_WIRELESS_IEEE_802_16').
-define('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_WIRELESS_IEEE_802_16', 27).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_WIRELESS_IEEE_802_20').
-define('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_WIRELESS_IEEE_802_20', 28).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_WIRELESS_IEEE_802_22').
-define('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_WIRELESS_IEEE_802_22', 29).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_PPPOA_PPP_OVER_ATM').
-define('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_PPPOA_PPP_OVER_ATM', 30).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_PPPOEOA_PPP_OVER_ETHERNET_OVER_ATM').
-define('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_PPPOEOA_PPP_OVER_ETHERNET_OVER_ATM', 31).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_PPPOEOE_PPP_OVER_ETHERNET_OVER_ETHERNET').
-define('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_PPPOEOE_PPP_OVER_ETHERNET_OVER_ETHERNET', 32).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_PPPOEOVLAN_PPP_OVER_ETHERNET_OVER_VLAN').
-define('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_PPPOEOVLAN_PPP_OVER_ETHERNET_OVER_VLAN', 33).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_PPPOEOQINQ_PPP_OVER_ETHERNET_OVER_IEEE_802_1QINQ').
-define('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_PPPOEOQINQ_PPP_OVER_ETHERNET_OVER_IEEE_802_1QINQ', 34).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_XPON_PASSIVE_OPTICAL_NETWORK').
-define('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_XPON_PASSIVE_OPTICAL_NETWORK', 35).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_WIRELESS_XGP').
-define('DIAMETER_3GPP_CHARGING_NAS-PORT-TYPE_WIRELESS_XGP', 36).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_TUNNEL-TYPE_PPTP').
-define('DIAMETER_3GPP_CHARGING_TUNNEL-TYPE_PPTP', 1).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_TUNNEL-TYPE_L2F').
-define('DIAMETER_3GPP_CHARGING_TUNNEL-TYPE_L2F', 2).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_TUNNEL-TYPE_L2TP').
-define('DIAMETER_3GPP_CHARGING_TUNNEL-TYPE_L2TP', 3).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_TUNNEL-TYPE_ATMP').
-define('DIAMETER_3GPP_CHARGING_TUNNEL-TYPE_ATMP', 4).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_TUNNEL-TYPE_VTP').
-define('DIAMETER_3GPP_CHARGING_TUNNEL-TYPE_VTP', 5).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_TUNNEL-TYPE_AH').
-define('DIAMETER_3GPP_CHARGING_TUNNEL-TYPE_AH', 6).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_TUNNEL-TYPE_IP_IP_ENCAP').
-define('DIAMETER_3GPP_CHARGING_TUNNEL-TYPE_IP_IP_ENCAP', 7).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_TUNNEL-TYPE_MIN_IP_IP').
-define('DIAMETER_3GPP_CHARGING_TUNNEL-TYPE_MIN_IP_IP', 8).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_TUNNEL-TYPE_ESP').
-define('DIAMETER_3GPP_CHARGING_TUNNEL-TYPE_ESP', 9).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_TUNNEL-TYPE_GRE').
-define('DIAMETER_3GPP_CHARGING_TUNNEL-TYPE_GRE', 10).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_TUNNEL-TYPE_DVS').
-define('DIAMETER_3GPP_CHARGING_TUNNEL-TYPE_DVS', 11).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_TUNNEL-TYPE_IP_IN_IP_TUNNELING').
-define('DIAMETER_3GPP_CHARGING_TUNNEL-TYPE_IP_IN_IP_TUNNELING', 12).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_TUNNEL-TYPE_VLAN').
-define('DIAMETER_3GPP_CHARGING_TUNNEL-TYPE_VLAN', 13).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_TUNNEL-MEDIUM-TYPE_IPV4').
-define('DIAMETER_3GPP_CHARGING_TUNNEL-MEDIUM-TYPE_IPV4', 1).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_TUNNEL-MEDIUM-TYPE_IPV6').
-define('DIAMETER_3GPP_CHARGING_TUNNEL-MEDIUM-TYPE_IPV6', 2).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_TUNNEL-MEDIUM-TYPE_NSAP').
-define('DIAMETER_3GPP_CHARGING_TUNNEL-MEDIUM-TYPE_NSAP', 3).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_TUNNEL-MEDIUM-TYPE_HDLC').
-define('DIAMETER_3GPP_CHARGING_TUNNEL-MEDIUM-TYPE_HDLC', 4).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_TUNNEL-MEDIUM-TYPE_BBN').
-define('DIAMETER_3GPP_CHARGING_TUNNEL-MEDIUM-TYPE_BBN', 5).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_TUNNEL-MEDIUM-TYPE_IEEE_802').
-define('DIAMETER_3GPP_CHARGING_TUNNEL-MEDIUM-TYPE_IEEE_802', 6).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_TUNNEL-MEDIUM-TYPE_E_163').
-define('DIAMETER_3GPP_CHARGING_TUNNEL-MEDIUM-TYPE_E_163', 7).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_TUNNEL-MEDIUM-TYPE_E_164').
-define('DIAMETER_3GPP_CHARGING_TUNNEL-MEDIUM-TYPE_E_164', 8).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_TUNNEL-MEDIUM-TYPE_F_69').
-define('DIAMETER_3GPP_CHARGING_TUNNEL-MEDIUM-TYPE_F_69', 9).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_TUNNEL-MEDIUM-TYPE_X_121').
-define('DIAMETER_3GPP_CHARGING_TUNNEL-MEDIUM-TYPE_X_121', 10).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_TUNNEL-MEDIUM-TYPE_IPX').
-define('DIAMETER_3GPP_CHARGING_TUNNEL-MEDIUM-TYPE_IPX', 11).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_TUNNEL-MEDIUM-TYPE_APPLETALK_802').
-define('DIAMETER_3GPP_CHARGING_TUNNEL-MEDIUM-TYPE_APPLETALK_802', 12).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_TUNNEL-MEDIUM-TYPE_DECNET4').
-define('DIAMETER_3GPP_CHARGING_TUNNEL-MEDIUM-TYPE_DECNET4', 13).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_TUNNEL-MEDIUM-TYPE_VINES').
-define('DIAMETER_3GPP_CHARGING_TUNNEL-MEDIUM-TYPE_VINES', 14).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_TUNNEL-MEDIUM-TYPE_E_164_NSAP').
-define('DIAMETER_3GPP_CHARGING_TUNNEL-MEDIUM-TYPE_E_164_NSAP', 15).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_ACCOUNTING-AUTH-METHOD_PAP').
-define('DIAMETER_3GPP_CHARGING_ACCOUNTING-AUTH-METHOD_PAP', 1).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_ACCOUNTING-AUTH-METHOD_CHAP').
-define('DIAMETER_3GPP_CHARGING_ACCOUNTING-AUTH-METHOD_CHAP', 2).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_ACCOUNTING-AUTH-METHOD_MS_CHAP_1').
-define('DIAMETER_3GPP_CHARGING_ACCOUNTING-AUTH-METHOD_MS_CHAP_1', 3).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_ACCOUNTING-AUTH-METHOD_MS_CHAP_2').
-define('DIAMETER_3GPP_CHARGING_ACCOUNTING-AUTH-METHOD_MS_CHAP_2', 4).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_ACCOUNTING-AUTH-METHOD_EAP').
-define('DIAMETER_3GPP_CHARGING_ACCOUNTING-AUTH-METHOD_EAP', 5).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_ACCOUNTING-AUTH-METHOD_UNDEFINED').
-define('DIAMETER_3GPP_CHARGING_ACCOUNTING-AUTH-METHOD_UNDEFINED', 6).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_ACCOUNTING-AUTH-METHOD_NONE').
-define('DIAMETER_3GPP_CHARGING_ACCOUNTING-AUTH-METHOD_NONE', 7).
-endif.
-ifndef('DIAMETER_3GPP_CHARGING_ORIGIN-AAA-PROTOCOL_RADIUS').
-define('DIAMETER_3GPP_CHARGING_ORIGIN-AAA-PROTOCOL_RADIUS', 1).
-endif.
